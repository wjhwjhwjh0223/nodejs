...
// 中间件（上传文件）
var multipartMiddleware_1 = require("./middleware/multipartMiddleware");
var common_1 = __importDefault(require("./config/common"));
var app = new koa_1.default();
app.use((0, koa_static_1.default)(__dirname + '/uploads'));
app.use((0, cors_1.default)());
app.use(multipartMiddleware_1.multipartFile);
...
data_source_1.AppDataSource.initialize().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        // 启动后台服务
        app.listen(common_1.default.port, function () {
            console.log("\u670D\u52A1\u5668\u542F\u52A8\u6210\u529F\uFF0C\u7AEF\u53E3\u4E3A\uFF1A ".concat(common_1.default.port));
        });
        return [2 /*return*/];
    });
